      ...
      return (
        <div className="mt-6 rounded-2xl border-2 border-[#feb139] bg-gradient-to-br from-[#feb139]/10 via-white to-[#feb139]/5 p-6 shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-[#25476a] pt-2 bg-gradient-to-r from-amber-50 to-orange-50 px-4 py-3 rounded-xl border-l-4 border-[#feb139] font-medium">
              This is a partial payment. Please complete the
              remaining balance to continue with the course.
            </p>
          </div>
        </div>
      );
